...
export default React.createClass({
  ...
  getInitialState() {
    ...
    return {
      user: {},
      url:"http://192.168.172.48:8080/ca/user/verification"
    }
  },
  ...
  render() {
    return (
      <div className="login">
        <div className="body">
          <Form ref="form" action="user/web/login" onSuccess={this.handleSuccess} data={this.state.user} onChange={this.handleChange} labelWidth={0} rules={this.rules}>
            <div className="logo">
              <h1>会议助手</h1>
            </div>
            <FormItem name="name">
            ...
            <FormItem name="verification">
              <FormInput placeholder="verification" style={{width:'130px',float:'left'}}></FormInput><img src={this.state.url} className="imgclass" onClick={this.handleClick}/>
            </FormItem>
